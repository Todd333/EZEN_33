...
def make_batch(seq_data):
    ...
    for seq in seq_data:
        ...
        #인코더 셀의 입력값, 입력 단어의 글자들을 한글자씩 떼어 배열로 만든다
        output = [num_dic[n] for n in ('S'+ seq[1])]
        #디코더 셀의 입력값, 시작을 나타내는 s심볼을 맨 앞에 붙인다.
        #S 는 디코더 입력의 시작
        #E 는 디코더 입력의 끝
...
with tf.variable_scope('dencode'):
    ...
    outputs, enc_states = tf.nn.dynamic_rnn(dec_cell, dec_input,
